function onCreate()
	--background boi
	makeLuaSprite('stage', 'back S', -600, -300)
	setLuaSpriteScrollFactor('stage', 0.9, 0.9)
	addLuaSprite('stage', false)

	makeLuaSprite( 'stage2', 'back SS', -600, -300)
	setLuaSpriteScrollFactor('stage2', 0.9, 0.9)
	addLuaSprite('stage2', false)

	makeLuaSprite( 'stage3', 'back SSS', -600, -300)
	setLuaSpriteScrollFactor('stage3', 0.9, 0.9)
	addLuaSprite('stage3', false)

	makeLuaSprite( 'stage4', 'back', -600, -300)
	setLuaSpriteScrollFactor('stage4', 0.9, 0.9)
